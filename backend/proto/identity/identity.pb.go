...
func (x *GetCapabilitiesResponse) GetMethods() []string {
	if x != nil {
		return x.Methods
	}
	return nil
...
var file_proto_identity_identity_proto_rawDesc = []byte{
	...
	0x08, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x18, 0x0a, 0x16, 0x47, 0x65, 0x74,
	0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x22, 0x57, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69,
	0x6c, 0x69, 0x74, 0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x22,
	...
	0x03, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x73, 0x32, 0x68, 0x0a, 0x0e,
	0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x56,
	...
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x72, 0x75, 0x70, 0x61, 0x6c, 0x64, 0x6f, 0x65, 0x73, 0x6e,
	0x6f, 0x74, 0x65, 0x78, 0x69, 0x73, 0x74, 0x73, 0x2f, 0x72, 0x65, 0x64, 0x70, 0x6f, 0x6c, 0x69,
	0x74, 0x69, 0x6b, 0x61, 0x2f, 0x63, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x69, 0x64,
...
var (
	...
	file_proto_identity_identity_proto_rawDescData = file_proto_identity_identity_proto_rawDesc
)

func file_proto_identity_identity_proto_rawDescGZIP() []byte {
	file_proto_identity_identity_proto_rawDescOnce.Do(func() {
		file_proto_identity_identity_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_identity_identity_proto_rawDescData)
	})
	return file_proto_identity_identity_proto_rawDescData
}

var file_proto_identity_identity_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_identity_identity_proto_goTypes = []interface{}{
	(*GetCapabilitiesRequest)(nil),  // 0: identity.GetCapabilitiesRequest
	(*GetCapabilitiesResponse)(nil), // 1: identity.GetCapabilitiesResponse
}
var file_proto_identity_identity_proto_depIdxs = []int32{
	0, // 0: identity.PluginIdentity.GetCapabilities:input_type -> identity.GetCapabilitiesRequest
	1, // 1: identity.PluginIdentity.GetCapabilities:output_type -> identity.GetCapabilitiesResponse
...
func file_proto_identity_identity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_identity_identity_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_identity_identity_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_identity_identity_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_proto_identity_identity_proto_rawDesc = nil
